...
package io.github.nikola_velemir.poshtar.spring.adapter.request.sender;
...
public class RequestTests {
    ...
    void should_Fail_For_Mandatory_Propagation() {
        ...
        Exception ex = assertThrowsExactly(IllegalTransactionStateException.class, () -> sender.send(request));
