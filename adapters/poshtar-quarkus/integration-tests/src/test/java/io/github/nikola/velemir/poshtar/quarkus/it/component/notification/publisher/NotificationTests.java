...
package io.github.nikola.velemir.poshtar.quarkus.it.component.notification.publisher;
...
public class NotificationTests {
    ...
    void should_Not_Fail_For_None_Registered() {
        ...
        assertDoesNotThrow(() -> {
            publisher.publish(noneNotification);
        });
    ...
    void should_Pass_For_Transactional() {
        ...
        assertDoesNotThrow(() -> {
            publisher.publish(transactionNotification);
        });
