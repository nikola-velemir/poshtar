 ...
 * <p>
 * This module scans the specified base packages for classes annotated with
 * {@link Handler}
 * and automatically binds them as Singletons. It also sets up the internal
 * registries
 ...
 * <li>Registers {@link RequestRegistry} and {@link NotificationRegistry} using
 * Guice-specific implementations.</li>
 * </ul>
 *
 * <p>
 * <b>Example Usage:</b>
...
public class PoshtarGuiceModule extends AbstractModule {
     ...
     * @param basePackages  The packages to scan for handlers and behaviors; if
     *                      empty, scans the entire classpath.
     */
     ...
     *
     * @param basePackages The packages to scan for handlers; if empty, scans the
     *                     entire classpath.
     */
