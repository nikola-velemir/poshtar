...
package io.github.nikola_velemir.poshtar.guice.adapter.pipeline.sender;
...
public class PipelineTests {
    ...
    void should_Respect_Order() {
        ...
        assertDoesNotThrow(() -> sender.send(orderRequest));
    ...
    void should_Work_For_Validation() {
        ...
        Exception ex = assertThrowsExactly(IllegalArgumentException.class, () -> sender.send(badValidationRequest));
    ...
    void should_Pass_For_Transactional() {
        ...
        assertDoesNotThrow(() -> sender.send(transactionalRequest));
    ...
    void should_Fail_For_Transactional() {
        ...
        assertThrowsExactly(RuntimeException.class, () -> sender.send(failTransactionalRequest));
