...
package io.github.nikola_velemir.poshtar.guice.adapter.notification.mediator;
 ...
 * narrower {@link io.github.nikola_velemir.poshtar.core.mediator.Publisher}
 * in the sibling {@code publisher} test class). Both resolve to the same
...
public class NotificationTests {
    ...
    void initTestContainer() {
        ...
        poshtar = testInjector.getInstance(Poshtar.class);
    }
    @AfterEach
    void tearDown() {
