...
public class TransactionalNotificationSecondHandler implements NotificationHandler<TransactionalNotification> {
    ...
    @Inject
    public TransactionalNotificationSecondHandler(Provider<EntityManager> entityManagerProvider) {
    ...
    public void handle(TransactionalNotification transactionalNotification) {
        ...
        assertTrue(isActive);
        TestEntity entity = new TestEntity("Second " + transactionalNotification.payload());
        em.persist(entity);
    }
}
