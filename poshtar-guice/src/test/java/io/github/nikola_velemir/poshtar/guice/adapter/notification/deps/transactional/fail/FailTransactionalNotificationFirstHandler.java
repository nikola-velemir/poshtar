...
@Handler
public class FailTransactionalNotificationFirstHandler implements NotificationHandler<FailTransactionalNotification> {
    private final Provider<EntityManager> entityManagerProvider;
    @Inject
    public FailTransactionalNotificationFirstHandler(Provider<EntityManager> entityManagerProvider) {
